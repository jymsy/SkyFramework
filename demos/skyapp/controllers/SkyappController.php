...
// 		return $_GET;
	 ...
	 */
	public function actionHello($par){
		echo $par;
...
// 	}
	 ...
	 */
	public function actionObject($par){
		$app = new \stdClass();
		$app->ap_name="jd";
		$app->ap_res="y";
		$app->ap_download_count=123;
...
// 			$this->goHome();
	...
	public function actionCatpchaa(){
// 		echo "ok";
// 		$this->render("testview",array("a"=>1,"b"=>2));
// 		echo $this->widget('Sky\web\widgets\captcha\Captcha',array(),true);
		
		$url=$this->createUrl('captcha',array('v'=>uniqid(),'_new'=>''));
		Sky::$app->request->redirect($url);
	}
