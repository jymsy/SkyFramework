...
defined('TVOS_MASTER') or define('TVOS_MASTER', '42.121.113.121:3306');//主数据库，用逗号分割不同主库
defined('TVOS_SLAVE') or define('TVOS_SLAVE', '42.121.113.121:3306');//从数据库，用逗号分割不同从库
...
defined('MEMCACHE_ENABLE') or define('MEMCACHE_ENABLE', true);//是否启用memcache
...
defined("PUSH_SERVER") or define('PUSH_SERVER','121.199.45.31:50026');
// defined("PUSH_SERVER") or define('PUSH_SERVER','tclb.skysrt.com:50026');
defined('EXTIP') or define('EXTIP', '42.121.113.121');//