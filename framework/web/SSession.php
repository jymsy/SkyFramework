...
class SSession extends Component implements \ArrayAccess, \Countable{
	 ...
	 */
	public $sessionTable = 'tb_base_session';
	...
	public function init(){
		...
		if (!$this->db instanceof ConnectionPool) {
			throw new \Exception("SSession::db must be either a DB connection instance or the application component ID of a DB connection.");
		}
		if($this->autoStart)
			$this->open();
